...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3995231483ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sostografia&table=rule">`sostografia`.`rule`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sostografia&table=category">`sostografia`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sostografia&table=questions">`sostografia`.`questions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sostografia&table=users">`sostografia`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sostografia&table=administrators">`sostografia`.`administrators`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sostografia&table=gradeperquestion">`sostografia`.`gradeperquestion`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sostografia&table=gradepercategory">`sostografia`.`gradepercategory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=administrators">`test`.`administrators`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="546a67407576333b6c216f456540783b">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="sostografia" targettable="rule">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `rule`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sostografia" targettable="rule">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `rule`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sostografia" targettable="category">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM category WHERE categoryID = 3;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sostografia" targettable="rule">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `rule` WHERE `rule`.`ruleID` = 2</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sostografia" targettable="category">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `ruleText` FROM `rule` WHERE `rule`.`ruleID` = 3</span>
                        </div>
